...
params = {
    # directories
    'outdir_run': f'../out/20.0909 Lx Sanger/L{Lx}only_reg_rf_boruta_all/',  # output dir for the run
    'outdir_modtmp': f'../out/20.0909 Lx Sanger/L{Lx}only_reg_rf_boruta_all/model_perf/',  # intermediate files for each model
