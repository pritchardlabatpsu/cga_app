...
show_columns = c("source", "term_id", "term_name","term_size","intersection_size"),filename = 'lx_bp.png')
...
show_columns = c("source", "term_id", "term_name","term_size","intersection_size"), filename = 'lx_mf.png')

# Highlight nucleus and lumen related terms in GO:CC
p.f4.cc = publish_gosttable(gostres.f4, res.gocc.f4[c(1:5),],use_colors = T,
show_columns = c("source", "term_id", "term_name","term_size","intersection_size"),filename = 'lx_cc.png')

# Plot highlighting top5 terms
p.f4 = publish_gostplot(p.f4, c(res.gobp.f4$term_id[1:5],res.gocc.f4$term_id[1:5],res.gomf.f4$term_id[1:5]), width = 15, height = 10,filename = 'lx.png')
```
