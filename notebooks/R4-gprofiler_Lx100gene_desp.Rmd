...
p.f4.bp = publish_gostplot(p.f4, res.gobp.f4[c(1:5),], width = 15, height = 10, filename = NULL)

# Highlight multiple protein binding related terms in GO:MF
p.f4.mf = publish_gostplot(p.f4, res.gomf.f4[c(1:5),], width = 15, height = 10, filename =NULL)

# Highlight nucleus and lumen related terms in GO:CC
p.f4.cc = publish_gostplot(p.f4, res.f4.cc[c(1:5),], width = 15, height = 10, filename = NULL)
